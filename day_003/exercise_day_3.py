...
# x = 2 and 3 then point is point1=(2,2) point2=(3,4)
change_in_y = int(4-2)
change_in_x = int(3-2)
...
print('The word on can be found in both \'python\' and \'dragon\': ', 'on' in 'dragon')
print()
...
print()
print('7/3 is equal to the converted value int 2.7: ', 7/3==2.7)
print()
print("'10' is equal to 10 in python: ", '10'==10)
print()
